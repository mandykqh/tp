...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_NRIC = "123456789";
    ...
    private static final ArrayList<JsonAdaptedAppointment> VALID_APPOINTMENTS =
            new ArrayList<>(BENSON.getPatientAppointments().stream()
                    .map(JsonAdaptedAppointment::new)
                    .collect(Collectors.toList()));
    private static final String VALID_NRIC = BENSON.getNric().nric;
    ...
    public void toModelType_invalidNric_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_NRIC, VALID_ADDRESS,
